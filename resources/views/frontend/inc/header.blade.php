<header class="site-navbar" role="banner">
    <div class="site-navbar-top" {{-- style="background-image: url('{{ asset('images/banner2.jpeg') }}')" --}}>
        ...
        <img src="{{ asset('images/mobile-banner.png') }}"
            srcset="{{ asset('images/mobile-banner.png') }} 480w, {{ asset('images/web-banner.png') }} 1200w"
            sizes="(max-width: 600px) 480px, (max-width: 900px) 800px, 1200px" class="site-navbar-top-image"
            alt="">
