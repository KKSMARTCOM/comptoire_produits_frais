            ...
            @foreach($promotions as $promotion)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('panel.promotions.edit', $promotion->id) }}" class="btn btn-warning">
                            <i class="fas fa-edit"></i> 
                        </a>
                    
                        <!-- Bouton Supprimer avec une icône -->
                        <form action="{{ route('panel.promotions.destroy', $promotion->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
