        ...
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    <h3 class="font-weight-bold">Bienvenue cher client</h3>
                    <h6 class="font-weight-normal mb-0">Les meilleurs produits frais de la capitale <span
                            class="text-primary">sont chez nous !</span></h6>
                </div>
